...
function WhoWeAre() {
  ...
  return (
    <div className="">
      <div
        className="whoweare mx-auto w-5/6 pt-[80px]"
        id={1 && "whoweare"}
      >
        ...
        <div className="whoweare-content flex lg:flex-row flex-col justify-between gap-2 items-center">
          <div className="md:w-3/5 md:mb-5 flex flex-col gap-5">
          ...
          <div className="img-whoweare flex md:flex-row md:justify-between gap-5 mx-auto justify-center">
