  ...
  return (
    <div className="my-10 mx-auto w-5/6">
      <div className="pt-[60px]">
        ...
        <div className="card-blog-1 rounded-3xl flex flex-row justify-between items-center bg-[#F8FFFE]">
            <div className="">
              <img src={designTips} alt="" className="rounded" />
            </div>
            <div className="mx-2 my-auto flex flex-col">
              <p className="text-xs font-normal">19 Feb, 2022/ By Admin</p>
              <p className="text-base lg:text-[26px] font-bold">
                UI/UX design Tips
              </p>
          ...
          <div className="card-blog-2 rounded-3xl flex flex-row justify-between items-center bg-[#F8FFFE]">
            <div className="">
              <img src={designTips} alt="" className="rounded" />
            </div>
            <div className="mx-2 my-auto flex flex-col ">
